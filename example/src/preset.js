...
export const globalInit = async () => {
  ...
  remoteLoaderPreset({
    remotes: {
      ...
      }, 'react-file-type': process.env.NODE_ENV === 'development' ? {
        remote: 'react-file-type', url: '/', tpl: '{{url}}'
      } : {
        ...registry, remote: 'react-file-type', defaultVersion: process.env.DEFAULT_VERSION
      }
    }
  });
